  ...
  const mockEntries = [
    {
      ...
      metrics: { f1: 0.8851, auc_roc: 0.9122, precision: 0.8911, recall: 0.8792 },
    ...
    },
    {
      ...
      metrics: { f1: 0.7421, auc_roc: 0.7812, precision: 0.7391, recall: 0.7451 },
    ...
    },
    {
      ...
      metrics: { f1: 0.8722, auc_roc: 0.9011, precision: 0.8652, recall: 0.8793 },
    ...
    },
    {
      ...
      metrics: { f1: 0.8122, auc_roc: 0.8512, precision: 0.8091, recall: 0.8153 },
    ...
    },
    {
      ...
      metrics: { f1: 0.8643, auc_roc: 0.8931, precision: 0.8542, recall: 0.8745 },
